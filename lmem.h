...
#define luaM_newvector(L, n, t) cast(t *, luaM_malloc_(L, cast_sizet(n) * sizeof(t), 0))
...
#define luaM_reallocvector(L, v, oldn, n, t) \
  (cast(t *,                                 \
        luaM_realloc_(L, v, cast_sizet(oldn) * sizeof(t), cast_sizet(n) * sizeof(t))))
...
LUAI_FUNC void *luaM_shrinkvector_(lua_State *L, void *block, int *nelem, int final_n,
                                   unsigned size_elem);
